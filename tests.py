...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_padding(self):
        print "".join(self.f3.transduce(x for x in "a12345"))
    ...
    def test_numbers(self):
        ...
        #     print " ".join(self.french.transduce(prepare_input(i)))
    ...
    def test_morphology(self):
        ...
        self.assertEqual(generate("ac+ing"), "acking")
